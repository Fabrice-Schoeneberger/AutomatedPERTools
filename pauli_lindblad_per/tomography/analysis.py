...
class Analysis:
    ...
    def __init__(self, layers, procspec, plusone=set()):
        ...
        for layer in self._layers:
            used_qubits = set()
            for inst in layer._cliff_layer:
                for q in inst.support():
                    used_qubits.add(q._index)
                
            self._data[layer] = LayerNoiseData(layer, plusone=plusone, used_qubits=used_qubits)
