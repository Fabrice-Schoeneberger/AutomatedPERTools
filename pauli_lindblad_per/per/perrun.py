...
class PERRun:
    ...
    def _generate(self):
        ...
        (self.instances, self._id, self._pickled_data) = _generate_but_outside_the_class(self._meas_bases, self._noise_strengths, self._samples, self._proc, self._inst_map, self._per_circ)
        self._counter = 0
