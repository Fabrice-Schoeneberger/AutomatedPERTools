...
noise_model.add_all_qubit_quantum_error(depolarizing_error(0.4,1), ['t'])
...
y_ideal = norm.pdf(0.14649921875, mean, std)



plt.scatter([average], [y_average], color='red', zorder=5)  # Mark points
plt.scatter([0.14649921875], [y_average/2], color='red', zorder=5)  # Mark points

plt.text(average, y_average, 'Measured average', color='black', fontsize=20, ha='center', va='bottom')

plt.text(0.14649921875, y_average/2, 'Ideal value', color='black', fontsize=20, ha='center', va='bottom')
plt.vlines([average], [0], [y_average], colors='red', linestyles='dotted')
plt.vlines([0.14649921875], [0], [y_average/2], colors='red', linestyles='dotted')
